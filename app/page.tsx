  ...
  return (
    <main>
      <nav className="nav-shell" aria-label="Navigazione principale">
        ...
        <div className="nav-links"><a href="#servizi">Servizi</a><a href="#studio">Lo studio</a><a href="#contatti">Contatti</a></div>
      ...
      <section className="hero" id="top">
        ...
        <a className="scroll-hint" href="#servizi"><ArrowDown size={16} /> Scopri lo studio</a>
